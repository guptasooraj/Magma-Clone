...
page2h1.textContent.split("").forEach((letter) => {
    text += `<span>${letter}</span>`;

    page2h1.innerHTML = text;
});
...
page4h1.textContent.split("").forEach((letter) => {
    text1 += `<span>${letter}</span>`;

    page4h1.innerHTML = text1;
});
...
page6h1.textContent.split("").forEach((letter) => {
    text2 += `<span>${letter}</span>`;

    page6h1.innerHTML = text2;
});
